import type { Announcement, Comment, DB, Pole, ScheduleSlot, Subject, User, Vote } from '../types';
...
export function seedDB(): DB {
  const users: User[] = [
    ...
    { id: 'u-prof', name: 'Pr. Pierre Kadet', email: 'prof@2late.com', password: 'prof', role: 'PROF', createdAt: hoursAgo(24 * 21) },
    { id: 'u-marc', name: 'Marc Obame', email: 'marc@2late.com', password: 'marc', role: 'RELAIS', pole: 'STI', createdAt: hoursAgo(24 * 18) },
    { id: 'u-nadia', name: 'Nadia Nzigou', email: 'nadia@2late.com', password: 'nadia', role: 'ETUDIANT', pole: 'SEDG', createdAt: hoursAgo(24 * 15) },
    { id: 'u-jean', name: 'Jean Moulougui', email: 'jean@2late.com', password: 'jean', role: 'ETUDIANT', pole: 'MPI', createdAt: hoursAgo(24 * 12) },
    { id: 'u-sophie', name: 'Sophie Bouanga', email: 'sophie@2late.com', password: 'sophie', role: 'ETUDIANT', pole: 'SVT', createdAt: hoursAgo(24 * 10) },
    { id: 'u-etu', name: 'Compte Étudiant Démo', email: 'etu@2late.com', password: 'etu', role: 'ETUDIANT', pole: 'STI', createdAt: hoursAgo(24 * 9) },
    { id: 'u-arnaud', name: 'Arnaud Bilie', email: 'arnaud@2late.com', password: 'arnaud', role: 'ETUDIANT', pole: 'STI', createdAt: hoursAgo(24 * 8) },
    { id: 'u-paul', name: 'Paul Nguema', email: 'paul@2late.com', password: 'paul', role: 'ETUDIANT', pole: 'MPI', createdAt: hoursAgo(24 * 7) },
    { id: 'u-lea', name: 'Léa Mengue', email: 'lea@2late.com', password: 'lea', role: 'ETUDIANT', pole: 'SHS', createdAt: hoursAgo(24 * 6) },
